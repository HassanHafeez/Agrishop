...
const speechRef = useRef(null); // Ref to store SpeechSynthesisUtterance
   ...
   <div className="max-w-4xl mx-auto px-4 py-8">
       ...
       <div className="flex flex-col md:flex-row bg-white shadow-lg rounded-lg overflow-hidden">
           ...
           <div className="md:w-1/2 p-4 flex items-center justify-center bg-gray-100">
               <img
                   src={imgSrc[product.id] || product.image} // Use state if it exists otherwise product.image
                   alt={product.title}
           ...
           <h2 className="text-3xl font-semibold mb-4 text-gray-900">{product.title}</h2>
              <p className="text-gray-700 mb-2">Price: Rs. {product.price}</p>
               ...
               <div className="flex space-x-4">
                ...
                <button className="bg-gray-200 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-300 transition duration-200">Shop Now</button>
               </div>
